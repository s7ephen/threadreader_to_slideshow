...
#   ---- 
#   The purpose of this code is to jumpstart the creation of a Hugo site (reveal-hugo markdown) using a collection
#   of twitter threads archived with threadreader_archive: https://github.com/s7ephen/threadreader_downloader 
#   
#   The threadreader_downloader tool produces a defined directory structure.
#   This tool will assume that pre-defined directory structure and use it
#   to generate a basic Hugo-Reveal directory. 
#
#   This tool also assumes the presence of a INI config file called threadreader_to_slideshow.ini 
#   
#   THE ASSUMED "threadreader_archive" GENERATED DIRECTORY STRUCTURE is as follows:
# 
# s7: ~/Desktop/DownloadingAllMyTwitterThreads$ tree --charset ascii  
# .
# |-- 1654103729031749632
# |   |-- raw_threadreaderapp_response.txt
# |   |-- tweet_1
# |   |   |-- FvSNtpRWIAEBRJx.jpg
# |   |   |-- FvSNv2iWYAIS6tH.jpg
# |   |   |-- tweet_raw.txt
...
#   ----
#
#   Note: this is intended to be run from s7dev container so directory mappings
#         are specific to that container.
#
#
#  A Asciinema recording of this in use is here:
#      ./threadreader_to_slideshow.asciinema
#  it can be played with "asciinema play threadreader_to_slideshow.asciinema"
#
#  or until 29June2024 here: https://asciinema.org/a/WA7E9QR86Kas3hOljndCZ519oa
#  (uploaded using an anonymous account, deleted every 7 days from their service)
try:
    import os
...
#                            print "\t\t", possible_tweetdir
                ...
                print "=============================="
                if not TESTRUN:
                    f_h = open(os.path.join(new_deck_outputdir, "_index.md"),'w')
                    print "[+] Writing deck ", candidate," to ", os.path.join(new_deck_outputdir, "_index.md")
                    f_h.write(str(deck))
                    f_h.close
            else:
